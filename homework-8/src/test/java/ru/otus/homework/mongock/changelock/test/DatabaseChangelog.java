package ru.otus.homework.mongock.changelock.test;
...
public class DatabaseChangelog {
    ...
    @ChangeSet(order = "005", id = "insertComments", author = "musin")
    public void insertComments(MongoDatabase db) {
        ...
        comments.insertMany(Arrays.asList(
                new Document().append("_id", "1")
                        .append("text", "Fascinating novel")
                        .append("bookId", "1"),
                new Document(),
                new Document().append("_id", "1")
                        .append("text", "Long and cruel text")
                        .append("bookId", "1")));
    }
