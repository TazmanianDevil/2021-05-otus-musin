...
public class DatabaseChangelog {
    ...
    public void insertInitData(MongoDatabase db) {
        ...
        myCollection.insertMany(Arrays.asList(
                ...
                new Document().append("_id", "2").append("name", "drama"),
                new Document().append("_id", "3").append("name", "fantasy"),
                new Document().append("_id", "4").append("name", "horror")
        ));
    }
    ...
    public void insertAuthors(MongoDatabase db) {
        ...
        myCollection.insertMany(Arrays.asList(
                ...
                new Document()
                        .append("_id", "2")
                        .append("fullName", "King Stephen Edwin")
        ));
    }
